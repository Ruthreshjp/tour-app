      ...
      <div className="w-full flex flex-col">
        <div className="backaground_image w-full flex flex-col">
          <div className="container max-w-7xl mx-auto px-4 lg:px-8">
            <h2 className="hidden lg:block text-3xl md:text-4xl font-bold text-yellow-500 mt-16">
              Find Your Perfect Trip
            </h2>
            <p className="hidden lg:block text-white text-lg max-w-md mt-3">
        ...
        <div className="top-part w-full mx-auto gap-2 flex flex-col items-center justify-center">
          <div className="container max-w-7xl mx-auto px-4 lg:px-8 flex flex-col items-center">
            ...
            <div className="w-full max-w-xl flex justify-center items-center gap-2 mt-8">
              <input
                type="text"
